...
function updateEvent(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const deleteEvent = yield databse_1.sequelize.query('UPDATE Events set EventName=? , date=? ,location=? WHERE EventID=?', {
...
function deleteEvent(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const deleteEvent = yield databse_1.sequelize.query('DELETE FROM Events WHERE EventID=?', {
